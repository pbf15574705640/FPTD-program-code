...
public class TestSubtractCircuit {
    ...
    public List<Circuit> buildCircuit1() {
        ...
        BigInteger secret1 = BigInteger.valueOf(37);
        BigInteger secret2 = BigInteger.valueOf(35);
        BigInteger secret3 = BigInteger.valueOf(38);
...
//            InputGate c = circuitI.input(owner_id, dim);
            Gate d = circuitI.subtract(a, b);
//            Gate e = circuitI.subtract(d, c);
