...
//       List<Circuit> circuits = buildCircuitForDivisionWithAddition();
    ...
    public List<Circuit> buildCircuit1() {
        ...
        BigInteger secret1 = BigInteger.valueOf(33203);
        BigInteger secret2 = BigInteger.valueOf(240000);

        System.out.println(secret1.subtract(Params.CONSTANT_FOR_LOG).pow(2).divide(Params.FIXED_DIVISOR_FOR_LOG));
        System.out.println(secret2.subtract(Params.CONSTANT_FOR_LOG).pow(2).divide(Params.FIXED_DIVISOR_FOR_LOG));
...
//            InputGate c = circuitI.input(owner_id, dim);
            //10, 24
            Gate d = circuitI.logarithm(a);
//            Gate e = circuitI.add(d, c);
